...
solucao, n_iteracoes, distancias_do_zero = newton_raphson_system(sistemas_para_resolver.func_1__duas_equacoes, sistemas_para_resolver.jacobian_func1__duas_equacoes, chute_inicial_func_1__duas_equacoes, 1e-30, 100)
solucao_2, n_iteracoes_2, distancias_do_zero_2 = newton_raphson_system(sistemas_para_resolver.func_2__duas_equacoes, sistemas_para_resolver.jacobian_func2__duas_equacoes, chute_inicial_func_2__duas_equacoes, 1e-30, 100)
solucao_3, n_iteracoes_3, distancias_do_zero_3 = newton_raphson_system(sistemas_para_resolver.func_1__tres_equacoes, sistemas_para_resolver.jacobian_func1__tres_equacoes, chute_inicial_func_1__tres_equacoes, 1e-30, 1000)
solucao_4, n_iteracoes_4, distancias_do_zero_4 = newton_raphson_system(sistemas_para_resolver.func_2__tres_equacoes, sistemas_para_resolver.jacobian_func2__tres_equacoes, chute_inicial_func_2__tres_equacoes, 1e-30, 1000)
